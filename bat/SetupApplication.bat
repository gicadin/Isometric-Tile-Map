...
:: Android packaging
set AND_CERT_NAME="RealmofKings"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\RealmofKings.p12
set AND_ICONS=bin/icons/android
...
set IOS_PROVISION=cert\RealmofKings.mobileprovision
